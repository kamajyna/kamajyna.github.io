...
6. Frontmatter에 대표 썸네일 이미지 URL을 다음 형식으로 작성할 것: `image: "https://image.pollinations.ai/prompt/[핵심_영어_키워드]?width=800&height=450&nologo=true"`. 여기서 '[핵심_영어_키워드]'는 본 포스트 주제를 나타내는 2~3개의 영어 단어(예: artificial_intelligence, server_room 등)를 쉼표나 언더스코어로 연결해서 넣어주세요. 본문 상단에도 동일한 URL로 썸네일 `![썸네일](URL)`을 포함할 것.
...
tags: [AI, 기술, 트렌드]
image: "https://image.pollinations.ai/prompt/artificial_intelligence,future?width=800&height=450&nologo=true"
---
